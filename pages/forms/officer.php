  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Registration Form : <b>Officer</b></h1>
          </div>
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default"> 
          ...
          <div class="card-body">
            <div class="row">
            <div class="col-md-12">
            <form action="../../actions/actions.php?f=register_officer" method="POST" autocomplete="off"> 
              <input type='hidden' name='id' value='<?php echo $_SESSION['u_id'];?>'>   
                  <div class="form-group">
                  <label>Student ID Number</label>
                    <input name="u_id" required type="number" class="form-control" id="" placeholder="Enter ID Number">
                </div>
                </div></br>
				<label>Position</label>
                    <input name="u_id" required type="text" class="form-control" id="" placeholder="Enter Position">
                </div>
                </div></br>
              <div class="col-md-4">
                <div class="form-group">
                ...
                <div class="col-md-2">
                  <div class="form-group">
                  <label>Age</label>
                    <input required name="age" type="number" class="form-control" id="" placeholder="Enter Age">
                </div>
                </div>
                ...
                <div class="col-md-6">
                  ...
                  <label>School Issued Email Address</label>
                    <input required name="u_email" type="email" class="form-control" id="" placeholder="Enter Email Address">
                </div>
                </div>
          <!-- /.card-body -->
