  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Registration Form : <b>Student</b></h1>
          </div>
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            <div class="row">
            <div class="col-md-12">
            <form action="../../actions/actions.php?f=register_stud" method="POST" autocomplete="off">    
              ...
              <div class="col-md-3">
                ...
                <div class="col-md-6">
                  ...
                  <label>Default Password</label>
                    <input readonly value='student' required name="pass" type="text" class="form-control" id="" placeholder="Enter Email Address">
                </div>
                </div>
                </div>
                </div>
