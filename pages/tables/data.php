            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                      $qry=("SELECT s_id,name,mid,last,grade,section FROM student ORDER BY last ASC");
                    ...
                    ?>
                  <tr>
                    <td><?php echo $data_row['last'];?></td>
                    <td><?php echo $data_row['name'];?></td>
                    <td><?php echo $data_row['mid'];?></td>
                    <td><?php echo $data_row['grade'];?></td>
                    <td><?php echo $data_row['section'];?></td>
                    ...
                    <td><a class="btn btn-outline-primary btn-sm"><i class="nav-icon fas fa-delete"></i>Delete</a></td>
                  </tr>
                    <?php 
                      include('../modal/updateStudent.php');
                      endwhile;
                      ?>
                  </tbody>
                </table>
