            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <th width="17%">Date</th>
                    <th width="17%">Area Concerned</th>
                    <th width="17%">Activity</th>
                    <th width="11%">Partner Organization</th>
                  ...
                  <tbody>
                   <?php
                      $qry=("SELECT c_id,date,area,activity,organization,budget,remarks FROM calendar");
                  ...
                  <tr>
                    ...
                    <td><?php echo $data_row['area'];?></td>
                    <td><?php echo $data_row['activity'];?></td>
                    <td><?php echo $data_row['organization'];?></td>
                    <td><?php echo $data_row['budget'];?></td>
                    ...
                    <?php 
                     //include('../modal/updateCalendar.php');
                      endwhile;
                      ?>
                  </tbody>
                </table>
