    ...
    <!-- Content Header (Page header) -->
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Officer List</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                      $qry=("SELECT s_id,name,mid,last,position FROM student WHERE position !='Regular' ORDER BY last ASC");
                  ...
                  <tr>
					...
					<td><?php echo $data_row['position'];?></td>
                    ...
                    <?php 
                      include('../modal/updateofficer.php');
                      endwhile;
                      ?>
                  </tbody>
                </table>
